...
int request_torrent_info_thread_ans (peer_data_t *peer, torrent_t *torrent)
{
    ...
    {
        ERROR_PRTF ("ERROR request_torrent_info_thread(): pthread_attr_init failed.\n");
        return -1;
    }
    if (pthread_attr_setdetachstate(&attr, PTHREAD_CREATE_DETACHED) != 0 )
    {
        ERROR_PRTF ("ERROR request_torrent_info_thread(): pthread_attr_setdetachstate failed.\n");
        return -1;
    }
    ...
    {
        ERROR_PRTF ("ERROR request_torrent_info_thread(): pthread_attr_destroy failed.\n");
        return -1;
    }
...
int request_torrent_peer_list_thread_ans (peer_data_t *peer, torrent_t *torrent)
{
    ...
    if (request_wrapper_data == NULL)
    {
        ERROR_PRTF ("ERROR request_torrent_peer_list_thread(): calloc failed.\n");
        return -1;
    }
    request_wrapper_data->peer = peer;
    request_wrapper_data->torrent = torrent;
    ...
    if (pthread_attr_init(&attr) != 0 )
    {
        ERROR_PRTF ("ERROR request_torrent_peer_list_thread(): pthread_attr_init failed.\n");
        return -1;
    }
    if (pthread_attr_setdetachstate(&attr, PTHREAD_CREATE_DETACHED) != 0 )
    {
        ERROR_PRTF ("ERROR request_torrent_peer_list_thread(): pthread_attr_setdetachstate failed.\n");
        return -1;
    }
    ...
    if (pthread_attr_destroy(&attr) != 0)
    {
        ERROR_PRTF ("ERROR request_torrent_peer_list_thread(): pthread_attr_destroy failed.\n");
        return -1;
    }
    return 0;
}
...
int request_torrent_block_status_thread_ans (peer_data_t *peer, torrent_t *torrent)
{
    ...
    if (request_wrapper_data == NULL)
    {
        ERROR_PRTF ("ERROR request_torrent_block_status_thread(): calloc failed.\n");
        return -1;
    }
    request_wrapper_data->peer = peer;
    request_wrapper_data->torrent = torrent;
    ...
    if (pthread_attr_init(&attr) != 0 )
    {
        ERROR_PRTF ("ERROR request_torrent_block_status_thread(): pthread_attr_init failed.\n");
        return -1;
    }
    if (pthread_attr_setdetachstate(&attr, PTHREAD_CREATE_DETACHED) != 0 )
    {
        ERROR_PRTF ("ERROR request_torrent_block_status_thread(): pthread_attr_setdetachstate failed.\n");
        return -1;
    }
    ...
    if (pthread_attr_destroy(&attr) != 0)
    {
        ERROR_PRTF ("ERROR request_torrent_block_status_thread(): pthread_attr_destroy failed.\n");
        return -1;
    }
    return 0;
}
...
int request_torrent_block_thread_ans (peer_data_t *peer, torrent_t *torrent, size_t block_index)
{
    ...
    if (request_wrapper_data == NULL)
    {
        ERROR_PRTF ("ERROR request_torrent_block_thread(): calloc failed.\n");
        return -1;
    }
    request_wrapper_data->peer = peer;
    request_wrapper_data->torrent = torrent;
    ...
    if (pthread_attr_init(&attr) != 0 )
    {
        ERROR_PRTF ("ERROR request_torrent_block_thread(): pthread_attr_init failed.\n");
        return -1;
    }
    if (pthread_attr_setdetachstate(&attr, PTHREAD_CREATE_DETACHED) != 0 )
    {
        ERROR_PRTF ("ERROR request_torrent_block_thread(): pthread_attr_setdetachstate failed.\n");
        return -1;
    }
    ...
    if (pthread_attr_destroy(&attr) != 0)
    {
        ERROR_PRTF ("ERROR request_torrent_block_thread(): pthread_attr_destroy failed.\n");
        return -1;
    }
    return 0;
}
...
int request_torrent_info_ans (peer_data_t *peer, torrent_t *torrent)
{
    ...
    {
        ERROR_PRTF ("ERROR request_torrent_info_ans(): send() failed - %d\n", peer_sock);
        close (peer_sock);
        return -2;
    }
    close (peer_sock);
...
int push_torrent_info_ans (peer_data_t *peer, torrent_t *torrent)
{
    ...
    if (write_bytes (peer_sock, msg, MSG_LEN) != MSG_LEN)
    {
        ERROR_PRTF ("ERROR push_torrent_info_ans(): send() failed.\n");
        close (peer_sock);
        return -2;
    }
...
int listen_socket_ans (int port)
{
    ...
    {
        ERROR_PRTF ("ERROR listen_socket_ans(): setsockopt() failed.\n");
        close (sockfd);
        return -1;
    }
    if (bind(sockfd, (struct sockaddr *) &serv_addr, sizeof(serv_addr)) < 0)
    {
        ERROR_PRTF ("ERROR listen_socket_ans(): bind() failed.\n");
        close (sockfd);
        return -1;
    }
    if (listen(sockfd, MAX_QUEUED_CONNECTIONS) < 0)
    {
        ERROR_PRTF ("ERROR listen_socket_ans(): listen() failed.\n");
        close (sockfd);
        return -1;
    }
    return sockfd;
...
int accept_socket_ans (int listen_sock, struct sockaddr_in *cli_addr, socklen_t *clilen)
{
    ...
    {
        ERROR_PRTF ("ERROR accept_socket_ans(): poll() failed.\n");
        return -2;
    }
    ...
    if (sockfd < 0) 
    {
        ERROR_PRTF ("ERROR accept_socket_ans(): accept() failed.\n");
        return -2;
    }
...
int connect_socket_ans (char *server_ip, int port)
{
    ...
    if (sockfd < 0) 
    {
        ERROR_PRTF ("ERROR connect_socket_ans(): socket() failed.\n");
        return -2;
    }
    ...
    if (sockfd == -1)
    {
        ERROR_PRTF ("ERROR connect_socket_ans(): setsockopt() failed.\n");
        return -2;
    }
    ...
    {
        ERROR_PRTF ("ERROR connect_socket_ans(): poll() failed.\n");
        close (sockfd);
        return -2;
    }
    ...
    {
        ERROR_PRTF ("ERROR connect_socket_ans(): getsockopt() failed.\n");
        close (sockfd);
        return -2;
    }
    if (err != 0)
...
int request_torrent_peer_list_ans (peer_data_t *peer, torrent_t *torrent)
{
    ...
    if (write_bytes (peer_sock, msg, MSG_LEN) != MSG_LEN)
    {
        ERROR_PRTF ("ERROR request_torrent_peer_list_ans(): send() failed - %d\n", peer_sock);
        close (peer_sock);
        return -2;
    }
    close (peer_sock);
...
int request_torrent_block_status_ans (peer_data_t *peer, torrent_t *torrent)
{
    ...
    if (write_bytes (peer_sock, msg, MSG_LEN) != MSG_LEN)
    {
        ERROR_PRTF ("ERROR request_torrent_block_status_ans(): send() failed - %d\n", peer_sock);
        close (peer_sock);
        return -2;
    }
    close (peer_sock);
...
int request_torrent_block_ans (peer_data_t *peer, torrent_t *torrent, size_t block_index)
{
    ...
    if (write_bytes (peer_sock, msg, MSG_LEN) != MSG_LEN)
    {
        ERROR_PRTF ("ERROR request_torrent_block_ans(): send() failed - %d\n", peer_sock);
        close (peer_sock);
        return -2;
    }
    close (peer_sock);
...
int push_torrent_peer_list_ans (peer_data_t *peer, torrent_t *torrent)
{
    ...
    if (write_bytes (peer_sock, msg, MSG_LEN) != MSG_LEN)
    {
        ERROR_PRTF ("ERROR push_torrent_peer_list_ans(): send() failed - %d\n", peer_sock);
        close (peer_sock);
        return -2;
    }
    ...
    if (buffer == NULL)
    {
        ERROR_PRTF ("ERROR push_torrent_peer_list_ans(): calloc() failed.\n");
        close (peer_sock);
        return -2;
    }
...
int push_torrent_block_status_ans (peer_data_t *peer, torrent_t *torrent)
{
    ...
    if (write_bytes (peer_sock, msg, MSG_LEN) != MSG_LEN)
    {
        ERROR_PRTF ("ERROR push_torrent_block_status_ans(): send() failed - %d\n", peer_sock);
        close (peer_sock);
        return -2;
    }
...
int push_torrent_block_ans (peer_data_t *peer, torrent_t *torrent, size_t block_index)
{
    ...
    if (write_bytes (peer_sock, msg, MSG_LEN) != MSG_LEN)
    {
        ERROR_PRTF ("ERROR push_torrent_block_ans(): send() failed - %d\n", peer_sock);
        close (peer_sock);
        return -2;
    }
    ...
    peer_data_t *peer, torrent_t *torrent, char *msg_body)
{
    ...
    INFO_PRTF ("\t[%04.3fs] RECEIVED 0x%08x BLOCK %ld REQUEST FROM %s:%d.\n", (double)get_elapsed_msec()/1000, 
        torrent->torrent_hash, block_index, peer->ip, peer->port);
    ...
    peer_data_t *peer, torrent_t *torrent, char *msg_body)
{
    ...
    {
        ERROR_PRTF ("ERROR handle_push_torrent_peer_list_ans(): calloc() failed.\n");
        close (peer_sock);
        return -1;
    }
    if (read_bytes (peer_sock, peer_list_buffer, peer_list_buffer_size) != peer_list_buffer_size)
    {
        ERROR_PRTF ("ERROR handle_push_torrent_peer_list_ans(): read() failed.\n");
        close (peer_sock);
    ...
    INFO_PRTF ("\t[%04.3fs] RECEIVED 0x%08x PEER LIST FROM %s:%d.\n", (double)get_elapsed_msec()/1000, 
        torrent->torrent_hash, peer->ip, peer->port);
    ...
    peer_data_t *peer, torrent_t *torrent, char *msg_body)
{
    ...
    {
        ERROR_PRTF ("ERROR handle_push_torrent_block_status_ans(): read() failed.\n");
        close (peer_sock);
        return -1;
    }
    close (peer_sock);
    ...
    peer_data_t *peer, torrent_t *torrent, char *msg_body)
{
    ...
    if (buffer == NULL)
    {
        ERROR_PRTF ("ERROR handle_push_torrent_block_ans(): malloc() failed.\n");
        close (peer_sock);
        return -1;
    }
    if (read_bytes (peer_sock, buffer, BLOCK_SIZE) != BLOCK_SIZE)
    {
        ERROR_PRTF ("ERROR handle_push_torrent_block_ans(): read() failed.\n");
        close (peer_sock);
        free (buffer);
        return -1;
    }
