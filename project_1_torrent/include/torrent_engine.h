// NXC Data Communications Network torrent_engine.h for BitTorrent-like P2P File Sharing System
...
#define PEER_LIST_MAX_BYTE_PER_PEER 22 // [PEER_X_IP]:[PEER_X_PORT] = "xxx.xxx.xxx.xxx:xxxxx "
